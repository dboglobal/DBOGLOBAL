#ifndef __SERVER_BOT_STATE_CASTINGITEM__
#define __SERVER_BOT_STATE_CASTINGITEM__

#include "CharState.h"

class CBotState_CastingItem : public CCharState
{

public:
	CBotState_CastingItem(CCharacter* pParent);
	virtual ~CBotState_CastingItem();
