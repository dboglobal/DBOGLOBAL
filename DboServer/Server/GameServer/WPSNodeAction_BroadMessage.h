#ifndef __SERVER_WPSNODE_ACTION_BROADMESSAGE__
#define __SERVER_WPSNODE_ACTION_BROADMESSAGE__


#include "ControlScriptNodeAction.h"
#include "DboTSCoreDefine.h"

class CWPSNodeAction_BroadMessage : public CControlScriptNodeAction
{

public:
	CWPSNodeAction_BroadMessage(const char* lpszName);
	virtual ~CWPSNodeAction_BroadMessage();
