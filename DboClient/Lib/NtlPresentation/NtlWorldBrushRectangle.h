...
class CNtlWB_Rectangle : public CNtlWorldBrushController
{
private:
	CBObjClass* m_pObj;
...
public:
	CNtlWB_Rectangle(eNTL_BRUSH_TYPE ID, CBObjClass* pObj, RwReal (CBObjClass::*pFunc)(RwV3d& Pos));
	~CNtlWB_Rectangle();
...
template <class CBObjClass>
CNtlWB_Rectangle<CBObjClass>::~CNtlWB_Rectangle()
{
}

template <class CBObjClass>
CNtlWB_Rectangle<CBObjClass>::CNtlWB_Rectangle(eNTL_BRUSH_TYPE ID, CBObjClass* pObj, RwReal (CBObjClass::*pFunc)(RwV3d& Pos))
{
	NTL_ASSERTE(pObj);
	NTL_ASSERTE(pFunc);
...
template <class CBObjClass>
RwV3d& CNtlWB_Rectangle<CBObjClass>::GetPosS()
{
	NTL_FUNCTION("CNtlWB_Rectangle<CBObjClass>::GetPosS");

	NTL_RETURN(m_PosS);
}

template <class CBObjClass>
RwV3d& CNtlWB_Rectangle<CBObjClass>::GetPosE()
{
	NTL_FUNCTION("CNtlWB_Rectangle<CBObjClass>::GetPosE");

	NTL_RETURN(m_PosE);
}

template <class CBObjClass>
void CNtlWB_Rectangle<CBObjClass>::SetPosS(RwV3d& Pos)
{
	NTL_FUNCTION("CNtlWB_Rectangle<CBObjClass>::SetPosS");
...
template <class CBObjClass>
void CNtlWB_Rectangle<CBObjClass>::SetPosE(RwV3d& Pos)
{
	NTL_FUNCTION("CNtlWB_Rectangle<CBObjClass>::SetPosE");
...
template <class CBObjClass>
RwReal CNtlWB_Rectangle<CBObjClass>::GetHeight(RwV3d& Pos)
{
	NTL_FUNCTION("CNtlWB_Rectangle<CBObjClass>::GetHeight");

	NTL_RETURN((m_pObj->*m_pFunc)(Pos));  
}

template <class CBObjClass>
void CNtlWB_Rectangle<CBObjClass>::Render()
{
	sLINE3D				BrushLine[2];
	RwV3d				Temp;
	...
	if(XIncreasePriority)
	{
		...
		for(RwInt32 i = static_cast<RwInt32>(m_PosS.x - 4.0f); i >= static_cast<RwInt32>(m_PosE.x); i -= ExtTile)
		{
			BrushLine[1].Pos.x = static_cast<RwReal>(i);
			BrushLine[1].Pos.z = m_PosS.z;
	...
	if(ZIncreasePriority)
	{
		...
		for(RwInt32 i = static_cast<RwInt32>(m_PosS.z - 4.0f); i >= static_cast<RwInt32>(m_PosE.z); i -= ExtTile)
		{
			BrushLine[1].Pos.x = m_PosS.x;
