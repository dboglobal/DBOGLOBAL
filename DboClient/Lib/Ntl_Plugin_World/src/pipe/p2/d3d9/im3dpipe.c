 ...
 *
 * The Im3D transform pipeline for D3D9 is shown below. Note that this
 ...
 *
 * The Im3D render pipelines for D3D9 are shown below. There is one for
 ...
 * pipelines.
 *
 * The D3D9 pipelines support triangle lists, strips and fans and line
 * lists and polylines.
 *
 * \verbatim
    ...
    if (pipe)
    {
        ...
        if (lpipe)
        {
            ...
            if (NULL != pipe)
            {
                ...
                RWRETURN(_rwD3D9Im3DRenderOpen());
            }
        }
