...
* Modify		: 2007. 10. 1 - Cho haesung �߰�(COptionControl)
...
#define dOPTION_VIRTUAL_NUM				9			// ������ ����Ʈ�� ����
#define dOPTION_VIRTUAL_NUM_CONTROL		9			// ����Ű���� ������ ����Ʈ�� ����
#define	dOPTION_VIRTUAL_HEIGHT			21			// The height of the list
#define	dOPTION_VIRTUAL_HEIGHT_EX		300			// �޺��ڽ� Ŭ�� �� ����
#define dOPTION_SCROLL_HEIGHT			345			// ��ũ�ѹ� ����
#define dOPTION_SCROLL_HEIGHT_CONRTOL	200			// ����Ű���� ��ũ�ѹ� ����
//
//// Video Mode ����Ʈ
...
* ���� ������ �����ϴ� ��ġ�� 0 ���� 50���� �����س���
* ���� ���̺귯���� BGM�� ���⸦ ���߱� ���Ͽ�
* BGM�� ������ Get * 200  ,  Set * 0.005 �� ��. Comment by Kell(2007. 12. 31)
*/
