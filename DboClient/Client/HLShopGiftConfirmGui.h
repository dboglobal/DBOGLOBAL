...
class CHLShopGiftConfirmGui : public CNtlPLGui, public RWS::CEventHandler
{
...
private:
	...
	gui::CStaticBox*	m_pstbCharacterTitle;
...
public:
	...
	CHLShopGiftConfirmGui(const RwChar* pName);
	~CHLShopGiftConfirmGui();
