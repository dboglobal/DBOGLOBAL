...
void PacketHandler_GSCharDestMove(void *pPacket)
{
	...
	//// Dest location counter�� �ݵ�� 1 �̻��̾�� �Ѵ�
	...
	//// Dest location counter�� �ݵ�� DBO_MAX_NEXT_DEST_LOC_COUNT ���� �۰ų� ���ƾ� �Ѵ�
...
void PacketHandler_GSCharUpdateZenny(void *pPacket)
{
	...
	if( pUpdateState->bIsNew )
	{
        ...
        if(pUpdateState->byChangeType != ZENNY_CHANGE_TYPE_PICK &&    // PICK�� PICK RES���� ó���Ѵ�.
		   pUpdateState->byChangeType != ZENNY_CHANGE_TYPE_PARTY_PICK ) // ZENNY_CHANGE_TYPE_PARTY_PICK : GU_ZENNY_PICK_RES ���� ó��
        {
...
void PacketHandler_GSCharStateWrong(void *pPacket)
{
	...
	if(g_bDispServerMsg)
	{
		...
		sprintf_s(chBuffer, 1024, "opcode(%s - �� ���¿��� ó���� �� ���� event), handle(%d) => send opcode(%s), server current state(%s)",
...
{	
	...
	else if(Logic_IsBlackList(pResult->handle)) // ��������Ʈ�� ��ϵǾ� �ִ� ��� ����  
	{
...
{
	// �������� �پ��� ������ GU_TRADE_START_RES�� ���� ��� GU_TRADE_CANCEL_NFY�� ����� �� �ִ�
	API_GetSLPacketLockManager()->Unlock( GU_TRADE_START_RES );
...
void PacketHandler_GSTradeCancelRes(void *pPacket)
{
	...
	// �������� �پ��� ������ GU_TRADE_START_RES�� ���� ��� GU_TRADE_CANCEL_RES�� ����� �� �ִ�
	API_GetSLPacketLockManager()->Unlock( GU_TRADE_START_RES );
...
void PacketHandler_GU_Progess_message_Nfy( void* pPacket ) 
{
	...
	// byProgressType, byMessageValue, byMessageType ������ ���� ���ڸ�
	// 2��° 3��° ���� �ٲپ �����Ѵ�
...
void PacketHandler_GUTeleportConfirmRes( void* pPacket )
{
	...
	// ResultCode �˻� �� ��� ���� TeleportProposalManager���� �޾Ƽ� ó���Ѵ�.
