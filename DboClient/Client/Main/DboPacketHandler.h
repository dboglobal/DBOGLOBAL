...
void PacketHandler_GSChildAdultSwitchedNfy(void* pPacket);              ///< � <-> ��̷� ����ɶ��� ��Ŷ
void PacketHandler_GSChangeClassAuthorityChangedNfy(void* pPacket);		///< �������� ȹ�� ��Ŷ
...
// Mob
void PacketHandler_GUBotCautionNfy(void* pPacket);                          ///< �������� ��ġë����
void PacketHandler_GUBotHelpMeNfy(void* pPacket);                           ///< ���� ���� ���ῡ�� ������ û�Ҷ�
...
// ���� ����
void PacketHandler_GUAfterEffectRemainTimeNfy(void* pPacket);               ///< ���� ������ ���� �ð�
void PacketHandler_GUTransformCancelRes(void* pPacket);                     ///< ���� ��� ��û�� ���� ����
void PacketHandler_GUMonsterTransformedNfy(void* pPacket);                  ///< ���� ���� �˸� ��Ŷ

// ����� ����
void PacketHandler_GUSkillConfuseTragetNfy(void* pPacket);                  ///< ȥ�� Ÿ���� �޴� ��Ŷ
void PacketHandler_GUSkillTerrorCourseChangeNfy(void* pPacket);             ///< ���� Ÿ���� �޴� ��Ŷ

// RankBattle Score
void PacketHandler_GUCharRankBattleScore(void* pPacket);				///< ��ũ��Ʋ Score
...
// ���ȭ ����
void PacketHandler_GUNetMarbleMemberShipNfy(void* pPacket);             ///< PC�� ������� ���� �޽���
