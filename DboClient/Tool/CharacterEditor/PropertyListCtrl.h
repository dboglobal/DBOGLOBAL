...
public:
	...
	virtual void OnLButtonDblClick(CPropertyItem* pPropertyItem, CPropertyListCtrl* pWndPropertyListCtrl, int nIndex);
	virtual void OnLButtonDown(CPropertyItem* pPropertyItem, CPropertyListCtrl* pWndPropertyListCtrl, int nIndex);
	...
	// Data
protected:
	CPropertyTypedPtrList<CObList, CPropertyItemCategory*> m_listPropertyItemTabs;
};
...
inline void CPropertyItemManager::OnLButtonDblClick(CPropertyItem* pPropertyItem, CPropertyListCtrl* pWndPropertyListCtrl, int nIndex)
{
}
inline void CPropertyItemManager::OnLButtonDown(CPropertyItem* pPropertyItem, CPropertyListCtrl* pWndPropertyListCtrl, int nIndex)
{
}
...
public:
	...
	// Operations
	void AttachCallBack(CWnd *pCallback);
...
inline void CPropertyItemManagerAdaptable::AttachCallBack(CWnd *pCallback)
{
