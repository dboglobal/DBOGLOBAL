========================================================================
    ACTIVE TEMPLATE LIBRARY : ERSManager Project Overview
========================================================================

AppWizard has created this ERSManager project for you to use as the starting point for
...
_ERSManager.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_ERSManager.h)
        GUID definitions                                (_ERSManager_i.c)
        A type library                                  (_ERSManager.tlb)
        Marshaling code                                 (_ERSManager_p.c and dlldata.c)
...
StdAfx.h, StdAfx.cpp
    ...
    named ERSManager.pch and a precompiled types file named StdAfx.obj.
...
ERSManagerps.vcproj
	...
	dlldata.c, ERSManager_i.c and ERSManager_p.c which are required
