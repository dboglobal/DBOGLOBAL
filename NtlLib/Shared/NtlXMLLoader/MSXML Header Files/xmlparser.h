...
HRESULT STDMETHODCALLTYPE IXMLParser3_SetProperty_Proxy( 
    IXMLParser3 * This,
    /* [in] */ const WCHAR *pwcName,
    /* [in] */ VARIANT value);


void __RPC_STUB IXMLParser3_SetProperty_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IXMLParser3_GetProperty_Proxy( 
    IXMLParser3 * This,
    /* [in] */ const WCHAR *pwcName,
    /* [retval][out] */ VARIANT *value);


void __RPC_STUB IXMLParser3_GetProperty_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
